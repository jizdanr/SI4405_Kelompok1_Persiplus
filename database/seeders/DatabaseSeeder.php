...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
     ...
     User::create([
        'name'=> 'Raden Endra Wijaya',
        'email'=>'radenendra@gmail.com',
        'password' => Hash::make('12345678'),
        'isAdmin' => '0',
     ]);
     User::create([
        'name'=> 'Nanda Wachika Brahmasta',
        'email'=>'nandawachika@gmail.com',
        'password' => Hash::make('12345678'),
        'isAdmin' => '0',
     ]);
     User::create([
        'name'=> 'Alif Fajar Maulana',
        'email'=>'aliffajar@gmail.com',
        'password' => Hash::make('12345678'),
        'isAdmin' => '0',
     ]);
    ...
    Buku::create([
        ...
        'Penerbit' => 'Andi',
        'tahun_terbit'=> '2015',
        'gambar'=> 'AlgoritmaDanPemrograman.jpeg',
    ...
    Buku::create([
        ...
        'Penerbit' => 'Tanesa',
        'tahun_terbit'=> '2021',
        'gambar'=> 'PemrogramanBerorientasiObjek.jpg',
